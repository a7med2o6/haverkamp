...
import { verifyWashAccess } from './actions';

/** أربعة أرقام تُكتب مرّة — ثم يُعاد تحميل الصفحة فيظهر كارت الغسيل */
export function VerifyForm({ token }: { token: string }) {
  const router = useRouter();
  const [state, formAction, pending] = useActionState(verifyWashAccess, { error: null });
