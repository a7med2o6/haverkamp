(function () {
  ...
  var _waLabel = (localStorage.getItem('hk_lang') || 'ar') === 'en' ? 'Contact via WhatsApp' : 'تواصل عبر واتساب';
  btn.setAttribute('aria-label', _waLabel);
  document.addEventListener('DOMContentLoaded', function () {
    document.querySelectorAll('.lang-btn').forEach(function (lb) {
      lb.addEventListener('click', function () {
        var nl = document.documentElement.getAttribute('lang') || 'ar';
        btn.setAttribute('aria-label', nl === 'en' ? 'Contact via WhatsApp' : 'تواصل عبر واتساب');
      });
    });
  });
